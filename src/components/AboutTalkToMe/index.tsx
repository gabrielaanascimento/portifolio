...
const AboutTalkToMe = ({email}: AboutTalkToMeProps) => {
    return (
        <section className="border-2 border-dashed border-zinc-200 rounded-lg p-8 text-center">
            ...
            <a href={`mailto:${email}`} className="px-5 py-2.5 rounded-full bg-indigo-500 text-white no-underline mr-3 hover:bg-indigo-600 transition-colors">Falar comigo</a>
